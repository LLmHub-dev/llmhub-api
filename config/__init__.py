...
def load_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        "AZURE_DEEPSEEK_MODEL": os.getenv("AZURE_DEEPSEEK_MODEL", ""),
        "AZURE_DEEPSEEK_PRICE_PER_MILLION_INPUT": os.getenv(
            "AZURE_DEEPSEEK_PRICE_PER_MILLION_INPUT"
        ),
        "AZURE_DEEPSEEK_PRICE_PER_MILLION_OUTPUT": os.getenv(
            "AZURE_DEEPSEEK_PRICE_PER_MILLION_OUTPUT"
        ),
        # ROUTER PRICING
